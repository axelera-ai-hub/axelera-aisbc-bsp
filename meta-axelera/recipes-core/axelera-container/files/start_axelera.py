...
def start(args):
    ...
    _run(
        ...
        '-v /usr/lib/libavfilter.so.8:/usr/lib/libavfilter.so.8 '
        '-v /usr/lib/libavformat.so.59:/usr/lib/libavformat.so.59 '
        '-v /usr/lib/libvulkan.so.1:/usr/lib/libvulkan.so.1 '
        '-v /usr/lib/libavcodec.so.59:/usr/lib/libavcodec.so.59 '
        '-v /usr/lib/libavutil.so.57:/usr/lib/libavutil.so.57 '
        '-v /usr/lib/libswscale.so.6:/usr/lib/libswscale.so.6 '
