...
def start(args):
    ...
    docker_cmd = (
        ...
        "-v /usr/lib/libdrm.so.2:/usr/lib/aarch64-linux-gnu/libdrm.so.2 "
        "-v /usr/share/vulkan:/usr/share/vulkan "
        "-v /usr/lib/libvulkan.so.1:/usr/lib/aarch64-linux-gnu/libvulkan.so.1 "
        "-v /usr/lib/libX11.so.6:/usr/lib/aarch64-linux-gnu/libX11.so.6 "
        "-v /usr/lib/libX11-xcb.so.1:/usr/lib/aarch64-linux-gnu/libX11-xcb.so.1 "
        "-v /usr/lib/libwayland-client.so.0:/usr/lib/aarch64-linux-gnu/libwayland-client.so.0 "
        "-v /usr/lib/libLLVM.so.21.1:/usr/lib/aarch64-linux-gnu/libLLVM.so.21.1 "
        "-v /usr/lib/libLLVMSPIRVLib.so.21.1:/usr/lib/aarch64-linux-gnu/libLLVMSPIRVLib.so.21.1 "
        "-v /usr/lib/libSPIRV-Tools.so:/usr/lib/aarch64-linux-gnu/libSPIRV-Tools.so "
        "-v /usr/lib/libSPIRV-Tools-shared.so:/usr/lib/aarch64-linux-gnu/libSPIRV-Tools-shared.so "
        "-v /usr/lib/libSPIRV-Tools-opt.so:/usr/lib/aarch64-linux-gnu/libSPIRV-Tools-opt.so "
        "-v /usr/lib/libSPIRV-Tools-link.so:/usr/lib/aarch64-linux-gnu/libSPIRV-Tools-link.so "
        "-v /usr/lib/libclang-cpp.so.21.1:/usr/lib/aarch64-linux-gnu/libclang-cpp.so.21.1 "
        "-v /usr/lib/libGLESv2.so.2:/usr/lib/aarch64-linux-gnu/libGLESv2.so.2 "
        "-v /usr/share/clc/spirv64-mesa3d-.spv:/usr/share/clc/spirv64-mesa3d-.spv "
