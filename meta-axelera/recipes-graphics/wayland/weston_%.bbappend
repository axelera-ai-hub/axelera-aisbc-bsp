...
USERADD_PARAM:${PN}:axelera-machine = "--uid 2000 --home /home/weston --shell /bin/sh --user-group -G video,input weston"
GROUPADD_PARAM:${PN}:axelera-machine = "--gid 2000 --system weston-launch"
