SUMMARY = "FFMpeg for rockchip devices."
DESCRIPTION = "This project aims to provide full hardware transcoding pipeline \
               in FFmpeg CLI for Rockchip platforms that support MPP \
               (Media Process Platform) and RGA (2D Raster Graphic \
               Acceleration). This includes hardware decoders, \
               encoders and filters. A typical target platform is \
               RK3588/3588s based devices."
HOMEPAGE = "https://github.com/nyanmisaka/ffmpeg-rockchip"
BUGTRACKER = "https://github.com/nyanmisaka/ffmpeg-rockchip/issues"
SECTION = "libs"
...
DEPENDS = "libdrm nasm-native rockchip-mpp"
...
SRC_URI = "\
    git://github.com/nyanmisaka/ffmpeg-rockchip.git;protocol=https;branch=master \
...
SRCREV = "4b0e6667111555d907591db9b76798c1e214ea8d"
...
# nooelint: oelint.vars.notneededspace
def cpu(d):
...
EXTRA_OECONF:append:mips = "\
    --extra-libs=-latomic --disable-mips32r5 --disable-mipsdsp --disable-mipsdspr2 \
